...
final class ViewController: UIViewController {
    ...
    @IBAction func didTappedStartRecButton(_ sender: UIButton) {
        ...
        if(!recorder.isRecording) {
            ...
            recorder.stopRecording { (previewController, error) in
                ...
                self.recordButton.setTitle("Tap to start recording", for: .normal)
            }
        }
    }
    
    @IBAction func didToggleMic(_ sender: UISwitch) {
